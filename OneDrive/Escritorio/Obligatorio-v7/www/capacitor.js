...
const capacitorExports = (function (e) {
  ...
  const n = ((e) =>
    ...
    i = n.setPlatform;
  var r;
  (e.ExceptionCode = void 0),
    ((r = e.ExceptionCode || (e.ExceptionCode = {})).Unimplemented =
      'UNIMPLEMENTED'),
    (r.Unavailable = 'UNAVAILABLE');
  class o extends Error {
    constructor(e, n, t) {
      super(e), (this.message = e), (this.code = n), (this.data = t);
    }
  }
  const s = (n) => {
      var t, i, r, s, a;
      const l = n.CapacitorCustomPlatform || null,
        d = n.Capacitor || {},
        c = (d.Plugins = d.Plugins || {}),
        u = n.CapacitorPlatforms,
        m =
          (null === (t = null == u ? void 0 : u.currentPlatform) || void 0 === t
            ? void 0
            : t.getPlatform) ||
          (() =>
            null !== l
              ...
              : ((e) => {
                  ...
                  return (null == e ? void 0 : e.androidBridge)
                    ...
                    : (
                        null ===
                          (t =
                            null === (n = null == e ? void 0 : e.webkit) ||
                            void 0 === n
                              ? void 0
                              : n.messageHandlers) || void 0 === t
                          ? void 0
                          : t.bridge
                      )
                    ? 'ios'
        ...
        f =
          (null === (i = null == u ? void 0 : u.currentPlatform) || void 0 === i
            ? void 0
            : i.isNativePlatform) || (() => 'web' !== m()),
        g =
          (null === (r = null == u ? void 0 : u.currentPlatform) || void 0 === r
            ? void 0
            : r.isPluginAvailable) ||
          ((e) => {
            const n = w.get(e);
        ...
        v =
          (null === (s = null == u ? void 0 : u.currentPlatform) || void 0 === s
            ? void 0
            : s.getPluginHeader) ||
          ((e) => {
            var n;
            return null === (n = d.PluginHeaders) || void 0 === n
              ? void 0
              : n.find((n) => n.name === e);
          }),
        w = new Map(),
        p =
          (null === (a = null == u ? void 0 : u.currentPlatform) || void 0 === a
            ? void 0
            : a.registerPlugin) ||
          ((n, t = {}) => {
            const i = w.get(n);
            if (i)
              return (
                console.warn(
                  `Capacitor plugin "${n}" already registered. Cannot register plugins twice.`,
                ),
                i.proxy
              );
            const r = m(),
            ...
            const u = (i) => {
                ...
                const u = (...u) => {
                  const m = (async () => (
                    !a && r in t
                      ? (a = a =
                          'function' == typeof t[r] ? await t[r]() : t[r])
                      : null !== l &&
                        !a &&
                        'web' in t &&
                        (a = a =
                          'function' == typeof t.web ? await t.web() : t.web),
                    a
                  ))().then((t) => {
                    const a = ((t, i) => {
                      var a, l;
                      if (!s) {
                        if (t)
                          return null === (l = t[i]) || void 0 === l
                            ? void 0
                            : l.bind(t);
                        throw new o(
                          `"${n}" plugin is not implemented on ${r}`,
                          e.ExceptionCode.Unimplemented,
                        );
                      }
                      {
                        const e =
                          null == s
                            ? void 0
                            : s.methods.find((e) => i === e.name);
                        if (e)
                          return 'promise' === e.rtype
                            ? (e) => d.nativePromise(n, i.toString(), e)
                            : (e, t) => d.nativeCallback(n, i.toString(), e, t);
                        if (t)
                          return null === (a = t[i]) || void 0 === a
                            ? void 0
                            : a.bind(t);
                      }
                    })(t, i);
                ...
                return (
                  (u.toString = () => `${i.toString()}() { [capacitor code] }`),
      ...
      return (
        d.convertFileSrc || (d.convertFileSrc = (e) => e),
        (d.getPlatform = m),
        (d.handleError = (e) => n.console.error(e)),
        (d.isNativePlatform = f),
        (d.isPluginAvailable = g),
        (d.pluginMethodNoop = (e, n, t) =>
          Promise.reject(`${t} does not have an implementation of "${n}".`)),
        (d.registerPlugin = p),
        (d.Exception = o),
        (d.DEBUG = !!d.DEBUG),
        (d.isLoggingEnabled = !!d.isLoggingEnabled),
        (d.platform = d.getPlatform()),
        (d.isNative = d.isNativePlatform()),
        d
      );
    },
    a = ((e) => (e.Capacitor = s(e)))(
  ...
  return (
    (e.Capacitor = a),
    (e.CapacitorException = o),
    (e.CapacitorPlatforms = n),
    (e.Plugins = d),
    (e.WebPlugin = class {
      constructor(e) {
        (this.listeners = {}),
      ...
      addListener(e, n) {
        ...
        const i = async () => this.removeListener(e, n),
          r = Promise.resolve({ remove: i });
        return (
    ...
    (e.registerWebPlugin = (e) =>
      ((e, n) => {
        ...
        console.warn(
          ...
          (r[i.name] &&
            !(null === (t = null == i ? void 0 : i.platforms) || void 0 === t
              ? void 0
              : t.includes(e.getPlatform()))) ||
            (r[i.name] = n);
      })(a, e)),
    (e.setPlatform = i),
